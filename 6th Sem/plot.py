...
# data_folder = "E:\\College Project\\College_Project"
...
# plt.figure(figsize=(10, 4))  # Extend width (x-axis) and reduce height (y-axis)
# u10_mean.plot(color='blue', label='10-meter U-component of Wind')

# # Customize the plot
# plt.title('10-meter U-component of Wind Over Time (2013 - 2024)', fontsize=16)
# plt.xlabel('Time (in Year)', fontsize=12)
# plt.ylabel('U10 (m/s)', fontsize=12)

# # Format the x-axis to show time labels more clearly
